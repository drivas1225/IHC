...
//            jointPosition.y - offsetPos.y + kinectManager.sensorHeight,  //!! this should be better investigated .. 
    ...
    {	
        ...
        //cam_head ovr
        cam_head.transform.position = GetJointWorldPos(KinectInterop.JointType.Head) - new Vector3 (0,0,1);
        //saber_left.transform.position = GetJointWorldPos(KinectInterop.JointType.HandLeft);
        //saber_right.transform.position = GetJointWorldPos(KinectInterop.JointType.HandRight);
        ...
        for (var boneIndex = 0; boneIndex < bones.Length; boneIndex++)
		{
			...
			if(boneIndex2JointMap.ContainsKey(boneIndex))
			{
                ...
                if( joint == KinectInterop.JointType.Head )   // skip head if moved externally
                {
